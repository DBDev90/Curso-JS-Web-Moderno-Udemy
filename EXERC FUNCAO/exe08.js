...
let valoresString = "30, 40, 20, 4, 51, 25, 42, 38, 56, 0"

const calcularPontuacao = (valoresString) => {
    let pontuacao = valoresString.split(', ')
...
console.log(calcularPontuacao(valoresString))
